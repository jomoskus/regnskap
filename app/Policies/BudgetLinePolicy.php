...
class BudgetLinePolicy
{
    ...
    {
        return $user->id === $budgetLine->user_id;
    }
     ...
     */
    public function restore(User $user, BudgetLine $budgetLine): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, BudgetLine $budgetLine): bool
    {
        return false;
    }
}
